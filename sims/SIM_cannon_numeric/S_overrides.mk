...
TRICK_CXXFLAGS += -I${QT_INSTALL_DIR}/include -I${QT_INSTALL_DIR}/include/QtCore -I${QT_INSTALL_DIR}/mkspecs/linux-g++
...
TRICK_USER_LINK_LIBS += -lQt5Core -lpthread -licui18n -licuuc -licudata
